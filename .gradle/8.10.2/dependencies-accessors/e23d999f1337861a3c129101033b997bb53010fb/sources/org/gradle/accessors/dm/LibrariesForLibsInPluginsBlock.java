...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final AparatLibraryAccessors laccForAparatLibraryAccessors = new AparatLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>jalalicalendar</b> with <b>ir.huri:JalaliCalendar</b> coordinates and
     * with version reference <b>jalalicalendar</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getJalalicalendar() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("jalalicalendar");
    }
    ...
    /**
     * Dependency provider for <b>persiandate</b> with <b>com.github.samanzamani:PersianDate</b> coordinates and
     * with version reference <b>persiandate</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getPersiandate() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("persiandate");
    }
    ...
    /**
     * Group of libraries at <b>aparat</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public AparatLibraryAccessors getAparat() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForAparatLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class AparatLibraryAccessors extends SubDependencyFactory {

        public AparatLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>view</b> with <b>com.github.codegamez:aparat-view</b> coordinates and
         * with version reference <b>aparatView</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class KaptLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>hilt</b> with <b>com.google.dagger:hilt-android-compiler</b> coordinates and
         * with version reference <b>hilt.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>aparatView</b> with value <b>0.0.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAparatView() { return getVersion("aparatView"); }
        ...
        /**
         * Version alias <b>firebaseInappmessagingDisplay</b> with value <b>21.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>jalalicalendar</b> with value <b>1.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJalalicalendar() { return getVersion("jalalicalendar"); }
        ...
        /**
         * Version alias <b>parc</b> with value <b>1.4.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getParc() { return getVersion("parc"); }

        /**
         * Version alias <b>persiandate</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPersiandate() { return getVersion("persiandate"); }
