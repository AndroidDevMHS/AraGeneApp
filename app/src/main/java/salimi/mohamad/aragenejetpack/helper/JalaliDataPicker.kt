...
import salimi.mohamad.aragenejetpack.ui.theme.textColorHighlight
import salimi.mohamad.aragenejetpack.ui.theme.textDisabledColor
import salimi.mohamad.aragenejetpack.utils.FormatHelper
import salimi.mohamad.aragenejetpack.utils.PickerType
...
//                            Log.d("DAGDAG", "onConfirm: ${it.day} ${it.monthString} ${it.year}")
                        ...
                        backgroundColor = MaterialTheme.colorScheme.backgroundColor,
                        dayOfWeekLabelColor =dayOfWeekLabelColor,
                        dropDownColor =  dropDownColor,
                        selectedIconColor =  MaterialTheme.colorScheme.selectedIconColor,
                        textColorHighlight =  MaterialTheme.colorScheme.textColorHighlight,
